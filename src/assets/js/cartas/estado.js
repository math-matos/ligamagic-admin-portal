...
const rotuloOrdenar = document.getElementById('rotulo-ordenar');
...
const CHAVE_ORDEM = 'cartas-ordem';
let ordemAlfabetica = localStorage.getItem(CHAVE_ORDEM) === 'desc' ? 'desc' : 'asc';
